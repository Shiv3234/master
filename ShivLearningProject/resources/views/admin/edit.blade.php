...
<div class="col-sm-12 col-xl-9">
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <form action="{{route('save.edit.profile')}}" method="post">
            @csrf
            <div class="row mb-3">
            <input type="hidden" name="id" id="id" class="form-control" value="{{$getDetails->id}}">
                <label for="name" class="col-sm-2 col-form-label">Full Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="name"  value="{{$getDetails->name}}">
                </div>
            </div>
            <div class="row mb-3">
                <label for="email" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" name="email" id="email"  value="{{$getDetails->email}}">
                </div>
            </div>
            <!-- <div class="row mb-3">
                <label for="password" class="col-sm-2 col-form-label">Password</label>
                <div class="col-sm-10">
                    <input type="password" class="form-control" name="password" id="password"  value="{{$getDetails->name}}">
                </div>
            </div> -->
            <div class="row mb-3">
                <label for="phone" class="col-sm-2 col-form-label">Phone no</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="phone" id="phone"  value="{{$getDetails->phone}}">
                </div>
            </div>
            <div class="row mb-3">
                <label for="address" class="col-sm-2 col-form-label">Address</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="address" id="autocomplete"  value="{{$getDetails->address}}">
                </div>
